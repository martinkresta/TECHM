...
typedef struct
{
	...
	uint8_t                     Main_Status;          /**< Stable value on pin (Filtered value) */
	uint8_t                     Last_Status;          /**< Last value on pin (Filtered value) */
	uint8_t                     Actual_Status;        /**< Actual vaulue on pin (Unfiltered value) */
